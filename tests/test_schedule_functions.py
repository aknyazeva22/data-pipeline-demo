...
SCHEDULE_1 = (
    "2022-01-01||2022-12-31||Special note||Closing note||09:00||12:00"
    "||14:00||18:00||09:00||12:00||14:00||18:00||09:00||12:00||14:00"
    "||18:00||09:00||12:00||14:00||18:00||09:00||12:00||14:00||18:00"
)
OUTPUT_1 = {
...
@pytest.mark.parametrize(
    ...
    [(SCHEDULE_1, OUTPUT_1), ("Invalid schedule format", None)],
)
def test_translate_schedule(schedule, expected_result):
    """
    Test translation of schedules from string format to a dictionary.

    The test checks that correct schedule string is translated to
    correct dictionary and that invalid schedule string is
    translated to None.

    The test is parametrized with two examples: one valid schedule
    string and one invalid schedule string.
    """
